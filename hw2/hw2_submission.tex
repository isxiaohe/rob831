...
% TODO
\centering
\includegraphics[height=8cm]{./data/q1_sb.png}
\end{answer}
...
% TODO
\centering
\includegraphics[height=8cm]{./data/q1_lb.png}
\end{answer}
...
\begin{answer}[title=Q5.1.3.1,height=4cm,width=\linewidth]
  The reward-to-go estimator generally performs better than the full trajectory and the improvement is significant.
\end{answer}

\subsubsubsection{Advantage standardization -- \lbrack1 points\rbrack}
\begin{answer}[title=Q5.1.3.2,height=4cm,width=\linewidth]
  Advantage standardization helps stabilize training and leads to better performance and the improvement is significant.
\end{answer}

\subsubsubsection{Batch size -- \lbrack1 points\rbrack}
\begin{answer}[title=Q5.1.3.3,height=4cm,width=\linewidth]
  Larger batch size leads to more stable training and better performance but the improvement is not very significant.
\end{answer}
